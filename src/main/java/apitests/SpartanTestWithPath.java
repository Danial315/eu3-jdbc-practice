...
public class SpartanTestWithPath {
    ...
    */
    ...
    public void getAllSpartanWithPath(){
        ...
        //to go from top to bottom we need to get by index otherwise it will gv all the values assigned to that key
        ...
        //print all names of spartans togthr
        List<String> names = response.path("name");
        System.out.println("names = " + names);

        //print all the phhone  numbers one by one separatly
